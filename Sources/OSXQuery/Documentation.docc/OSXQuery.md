...
OSXQuery provides a comprehensive interface for interacting with macOS accessibility APIs. It enables automated testing, UI automation, and accessibility tooling with a modern Swift API.

// ResponseModels.swift - Contains response model structs for OSXQuery commands

import Foundation

// MARK: - AXErrorCode

// Error codes for OSXQuery operations
...
// Main response enum for OSXQuery operations
...
// Definition for AXElementData based on usage in OSXQuery+QueryHandlers.swift

...
/// Enumeration of all supported OSXQuery accessibility commands.
///
/// AXCommand defines the complete set of operations that can be performed
/// through the OSXQuery accessibility automation framework. Each case
...
///
/// // Execute through OSXQuery
/// let envelope = AXCommandEnvelope(commandID: "search", command: command)
/// let response = osxquery.runCommand(envelope)
/// ```
...
/// primary interface used by OSXQuery for command execution.
///
/// ## Topics
///
/// ### Properties
...
public struct AXCommandEnvelope: Sendable {
    ...
    /// performed by the OSXQuery framework.
